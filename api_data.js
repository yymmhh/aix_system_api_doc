define({ "api": [
  ...
  {
    "type": "get",
    "url": "api/v1/wx/jobfairnet/blue/show/quarters/find?id=156",
    "title": "蓝领招聘会参会职位详情",
    "name": "blue_show_quarters_find",
    "group": "GroupJobFairBlue",
    "permission": [
      {
        "name": "token"
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "请求示例:",
          "content": "{\"im_id\":\"aix_v1_b_c_316_49\"}",
          "type": "json"
        }
      ]
    },
    "success": {
      "examples": [
        {
          "title": "成功200:",
          "content": "{\n\"message\": \"OK\",\n\"status\": 200,\n\"data\": [\n{\n\"utype\": \"1//用户类型\",\n\"job_id\": \"13//职位id8\",\n\"job_name\": \"划水工程师//职位名称\",\n\"company_name\": \"上海朗绿建筑科技有限公司//企业名称\",\n\"wage\": \"10000以上/月//薪资\",\n\"jobsContent\": \"划水//工作内容\",\n\"jobUrl\": \"jobfairBlue/show/quarters/138\",\n\"district\": \"北京/北京市/石景山区//地址\",\n\"education\": \"不限学历//学历\"\n}\n]\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "post",
    "url": "api/v1/wx/jobfairnet/im/group/get/resumes",
    "title": "(个人)获取我审核通过的简历",
    "name": "im_group_get_resumes",
    "group": "GroupJobFairBlue",
    "permission": [
      {
        "name": "token"
    ...
    "success": {
      "examples": [
        {
          "title": "成功200:",
          "content": "{\n\"status\": 200,\n\"msg\": \"success\",\n\"data\": [\n{\n\"utype\": 2,\n\"resume_id\": 256,\n\"resume_name\": \"简历1\",\n\"realname\": \"蒋林姓名是最长的时候\",\n\"sex_cn\": \"男\",\n\"education_cn\": \"硕士\",\n\"experience_cn\": \"3-5年\",\n\"residence_cn\": \"浙江-舟山\",\n\"householdaddress_cn\": \"浙江-舟山\",\n\"wage\": \"3000~5000/月\",\n\"intention_jobs\": \"前台/总机/接待+人事专员/助理+人事经理/主管+行政专员/助理+分公司经理\",\n\"resumeUrl\": \"content/resumes/show?id=256&token=1\",\n\"specialty\": \"测试测试！\",\n\"mobile\": 15625241475\n}\n]\n}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "on_join",
            "description": "<p>为1的时候只需要带新加入的职位,不会过滤掉老的职位</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "api/v1/wx/jobfairnet/blue/cache?id=49",
    "title": "蓝领招聘会大厅企业和个人的心跳包",
    "name": "jobfairnet_blue_cache",
    "group": "GroupJobFairBlue",
    "permission": [
      {
        "name": "token"
  ...
  {
    "type": "post",
    "url": "api/v1/wx/jobfairnet/im/group/resume/apply?im_id=aix_v1_b_m_353_58",
    "title": "蓝领查看联系方式",
    "name": "jobfairnet_im_group_resume_apply",
    "group": "GroupJobFairBlue",
    "permission": [
      {
        "name": "token"
